...
from .views import PayRollListView, AttendanceListView, EmployeeListView, AdditionListView, DeductionListView
...
urlpatterns = [
    ...
    path('deduction/', DeductionListView.as_view(), name='deduction'),
